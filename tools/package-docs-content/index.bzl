...
def _package_docs_content(ctx):
    ...
    # "bin/src/dino-examples/docs-content/docs-content". The reason we need to
    ...
    # so all contents of the docs-content would be put directly into the @dino/dino-examples package.
