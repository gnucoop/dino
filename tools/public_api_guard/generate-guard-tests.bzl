...
def generate_test_targets(golden_files):
    for golden_file in golden_files:
        ...
        ts_api_guardian_test(
            ...
            actual = "dewco/src/%s/index.d.ts" % entry_point_path,
            data = [golden_file] + [
                "//src/%s" % (entry_point_path),
            ],
            golden = "dewco/tools/public_api_guard/%s" % golden_file,
            use_angular_tag_rules = False,
            # Required for the `PouchDB` packages. "i0" is
            # generated by ngtsc for creating directive, module definitions.
            allow_module_identifiers = ["i0", "PouchDB"],
        )
