...
export declare class SelectionList<T extends Model = Model> extends List<T> implements AfterContentInit, AfterViewInit, OnInit, OnDestroy {
    ...
    selectAll(): void;
    static ɵcmp: i0.ɵɵComponentDefWithMeta<SelectionList<any>, "dewco-list", never, { "customFilters": "customFilters"; "additionalBasicFilters": "additionalBasicFilters"; "dataSource": "dataSource"; }, {}, ["filtersComponent", "cellTemplates"], ["[filters]"]>;
    static ɵfac: i0.ɵɵFactoryDef<SelectionList<any>, never>;
}
