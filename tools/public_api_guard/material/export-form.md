...
export class ExportBottomSheet {
    ...
    // (undocumented)
    static ɵcmp: i0.ɵɵComponentDeclaration<ExportBottomSheet, "dino-export-form-bottom-sheet", never, {}, {}, never, never>;
    // (undocumented)
...
export class ExportSelectAllButtonComponent {
    ...
    toggle(): void;
    // (undocumented)
    static ɵcmp: i0.ɵɵComponentDeclaration<ExportSelectAllButtonComponent, "dino-export-form-select-all-button", never, { "group": "group"; }, { "change": "change"; }, never, ["*"]>;
    // (undocumented)
