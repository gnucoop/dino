...
import * as i5 from '@dewco/material/icons-service';
...
export class EditFormSchema implements OnInit, OnDestroy {
    ...
    save(): void;
    // (undocumented)
    static ɵcmp: i0.ɵɵComponentDeclaration<EditFormSchema, "dewco-edit-form-schema", never, { "formConvUrl": "formConvUrl"; }, {}, never, never>;
    // (undocumented)
...
export class ImportFormSchema {
    ...
    // (undocumented)
    static ɵcmp: i0.ɵɵComponentDeclaration<ImportFormSchema, "dewco-import-form-schema", never, {}, {}, never, never>;
    // (undocumented)
