...
export declare abstract class DataModelManager<T extends Model = Model> {
  ...
  constructor(
    ...
    _contextService: PermissionContextService,
...
export interface DataServiceSyncOptions
  extends Omit<SyncOptionsGraphQL, 'headers' | 'pull' | 'push' | 'deletedFlag'> {
...
export declare type InsertModel<T extends Model> = Omit<
  T,
  'id' | 'created_at' | 'updated_at' | '_deleted'
>;
