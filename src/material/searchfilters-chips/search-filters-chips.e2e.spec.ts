...
describe('dewco-mat-searchfilters-chips', () => {
  ...
  it('should find a dewco-mat-searchfilters-chips component', async () => {
    const chips = element(by.css('dewco-mat-searchfilters-dialog dewco-mat-searchfilters-chips'));

    expect(await chips.isPresent()).toBe(true);
    expect(await chips.isDisplayed()).toBe(false);
  });

  it('should add a chip to the dewco-mat-searchfilters-chips component', async () => {
    ...
    const addedChips = chips.all(by.css('dewco-mat-searchfilters-dialog mat-chip'));
  ...
  it('should remove a chip and exclude the associated filter widget', async () => {
    const chips = element(by.css('dewco-mat-searchfilters-dialog dewco-mat-searchfilters-chips'));
    const activeChip = chips.all(by.css('dewco-mat-searchfilters-dialog mat-chip')).first();
