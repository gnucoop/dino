...
import {SearchFiltersPresetManager} from '@dewco/material/searchfilters-preset-manager';
...
describe('Search filters Bar', () => {
  ...
  it('should save a preset in the localStorage', () => {
    fixturePresetManager.detectChanges();
    const spySetItem = spyOn(localStorage, 'setItem').and.callThrough();
  ...
  it('should retrieve a preset from the localStorage and ask the FilterService to load it', () => {
    fixturePresetManager.detectChanges();
    const spyGetItem = spyOn(localStorage, 'getItem').and.callThrough();
