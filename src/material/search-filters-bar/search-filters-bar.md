The `@dewco/material/search-filters-bar` module provides a main filtering component that can be associated to a Selection List
ad it's usually displayed as a toolbar on top of it.
It displays the default basic filters, inherited from `@dewco/core/list` SearchFiltersComponent, and allows the setting and displaying of 
