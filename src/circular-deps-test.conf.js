...
/**
 * Custom module resolver that maps specifiers starting with `@dino/` to the
...
function resolveModule(specifier) {
  if (specifier.startsWith('@dino/')) {
    return path.join(__dirname, specifier.substr('@dino/'.length));
  }
  return null;
}
