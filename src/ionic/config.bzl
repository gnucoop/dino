...
# List of all testing entry-points of the Dewco ionic package.
...
# List of all entry-point targets of the Dewco ionic package.
IONIC_TARGETS = ["//src/ionic"] + ["//src/ionic/%s" % ep for ep in IONIC_ENTRYPOINTS]

# List of all testing entry-point targets of the Dewco ionic package.
