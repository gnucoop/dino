...
var specFiles = Object.keys(window.__karma__.files).filter(isDewcoSpecFile);
...
/** Runs the Angular Dewco specs in Karma. */
function runDewcoSpecs() {
...
/** Whether the specified file is part of Angular Dewco. */
function isDewcoSpecFile(path) {
 ...
 * each unit test.
 *
 * Without this patch, the combination of two behaviors is problematic for Dewco:
