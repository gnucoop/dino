...
export const ENG: Translation = {
  ...
  'Deselect': 'Deselect',
  'fields selected out of': 'fields selected out of',
  'Select all Form fields': 'Select all Form fields',
  ...
  'New': 'New',
  'Case management': 'Case management',
  'Form status associated with the form': 'Form status associated with the form',
  'fields': 'fields',
  'Pause': 'Pause',
  'Resume': 'Resume',
  'Scroll to see all the fields. You can name them in any order.':
    'Scroll to see all the fields. You can name them in any order.',
  'Drag an audio file or a PDF here': 'Drag an audio file or a PDF here',
  'MP3, WAV, OGG, PDF or image': 'MP3, WAV, OGG, PDF or image',
  'Dino AI is reading your recording…': 'Dino AI is reading your recording…',
  'text': 'text',
  'long text': 'long text',
  'number': 'number',
  'yes / no': 'yes / no',
