...
export const ENG: Translation = {
  ...
  'No section matches': 'No section matches',
  '{{count}} sections need attention': '{{count}} sections need attention',
  'Cannot save, some sections need attention': 'Cannot save, some sections need attention',
  'Number of {{name}}': 'Number of {{name}}',
