...
export const PRT: Translation = {
  ...
  'Sources': 'Fontes',
  'Specify a date range to filter the data (optional).': 'Especifique um intervalo para filtrar os dados (opcional).',
  ...
  'You can specify only one of the two extremes of the range, or neither.': 'Você pode especificar apenas um dos dois extremos do intervalo, ou nenhum.',
