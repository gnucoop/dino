...
export const PRT: Translation = {
  ...
  'Section': 'Seção',
  'Section {{current}} of {{total}}': 'Seção {{current}} de {{total}}',
  'Previous section': 'Seção anterior',
  'Next section': 'Próxima seção',
  '{{percent}}% filled': '{{percent}}% preenchido',
  '{{done}} of {{total}} sections complete': '{{done}} de {{total}} seções completas',
  'More below': 'Mais abaixo',
  'Search section': 'Pesquisar seção',
  'No section matches': 'Nenhuma seção corresponde',
