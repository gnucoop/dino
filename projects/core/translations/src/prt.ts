...
export const PRT: Translation = {
  ...
  'Use': 'Use',
  'for dynamic placeholders.': 'para os marcadores dinâmicos.',
  'optional': 'opcionais',
  'filled': 'preenchidas',
  ...
  'All keys': 'Todas',
  'To translate': 'Por traduzir',
  'No results': 'Sem resultados',
  'Translation key': 'Chave de tradução',
  'Rename key': 'Renomear chave',
  'languages translated': 'idiomas traduzidos',
  'Saving…': 'A guardar…',
  'Saved': 'Guardado',
  'Save failed': 'Falha ao guardar',
  'Translated': 'Traduzido',
  'Missing': 'Em falta',
  'Add translation {{language}}…': 'Adicionar tradução {{language}}…',
  'Select a translation key': 'Selecione uma chave de tradução',
  'Log out': 'Sair',
  ...
  'columns detected': 'colunas detectadas',
  'columns': 'colunas',
  'mapped': 'mapeadas',
  'ignored': 'ignoradas',
  ...
  "An automatic report already exists for this form. To disable it, delete that report's schema and data.":
    'Já existe um relatório automático para este formulário. Para desativá-lo, elimine o esquema e os dados desse relatório.',
  'Save the form first to add relationships':
    'Salve primeiro o formulário para adicionar relacionamentos',
  ...
  'Data': 'Dados',
  'Map': 'Mapa',
  'Ask your data': 'Pergunte aos seus dados',
  'Ask a question in natural language about this form data': 'Faça uma pergunta em linguagem natural sobre os dados deste formulário',
  'Write a question about the data...': 'Escreva uma pergunta sobre os dados...',
  'New chat': 'Novo chat',
  'Chats': 'Chats',
  ...
  'Good response': 'Resposta útil',
  'Bad response': 'Resposta não útil',
  'Suggested questions': 'Perguntas sugeridas',
  'Copy': 'Copiar',
  'Copied': 'Copiado',
  'Regenerate answer': 'Gerar novamente a resposta',
  'Could not download the export file': 'Não foi possível descarregar o ficheiro exportado',
  'The chat session has ended. Please run the query again': 'A sessão de chat terminou. Por favor, repita a pergunta',
  'This download is no longer available. Please run the query again': 'Esta transferência já não está disponível. Por favor, repita a pergunta',
  'Showing the first {{preview}} of {{total}} rows': 'São mostradas as primeiras {{preview}} linhas de {{total}}',
  'Not all rows are shown': 'Nem todas as linhas são mostradas',
  'Only {{preview}} of {{total}} columns are shown': 'São mostradas apenas {{preview}} colunas de {{total}}',
  'This chart could not be displayed': 'Não foi possível mostrar este gráfico',
  'No data to display': 'Não há dados para mostrar',
  'How many records were collected this month?': 'Quantos dados foram recolhidos este mês?',
  'Summarize the collected notes': 'Resuma as notas recolhidas',
  'Compare the activities by organization': 'Compare as atividades por organização',
  ...
  'DINO-AI API Key': 'Chave API DINO-AI',
  'Download backup': 'Transferir backup',
  'Export a full copy of the data, or restore a previous backup.': 'Exporte uma cópia completa dos dados ou restaure um backup anterior.',
  'Hide': 'Ocultar',
  'Load preset': 'Carregar predefinição',
  'No DINO-AI key is associated with this account': 'Não existe nenhuma chave DINO-AI associada a esta conta',
  'Pick a color': 'Escolher uma cor',
  'Preset name': 'Nome da predefinição',
  'Preview': 'Pré-visualização',
  'Primary': 'Primário',
  'Reset': 'Repor',
  'Restoring overwrites the current data': 'O restauro substitui os dados atuais',
  'Save theme': 'Guardar tema',
  'Show': 'Mostrar',
  'Take the guided tour of Dino again.': 'Faça novamente a visita guiada do Dino.',
  ...
  'With active filters': 'Com filtros ativos',
  'Sections': 'Secções',
  ...
  'fields selected out of': 'campos selecionados de',
  'Select all Form fields': 'Selecionar todos os campos do formulário',
  'Label values': 'Valores das etiquetas',
  'Data Analysis format': 'Formato Data Analysis',
  'Separate columns': 'Colunas separadas',
  'Step 1 of 2': 'Passo 1 de 2',
  'Form metrics': 'Métricas do formulário',
  'Report metrics': 'Métricas do relatório',
  'These values decide how the submission is dated and grouped in reports and aggregations. Nothing here is part of the questionnaire itself.':
    'Estes valores determinam a data do registo e como é agrupado em relatórios e agregações. Nada aqui faz parte do questionário em si.',
  'Select…': 'Selecionar…',
  'Change': 'Alterar',
  'New': 'Novo',
  'Case management': 'Gestão de casos',
  'Form status associated with the form': 'Estado associado ao formulário',
  'fields': 'campos',
  'Scroll to see all the fields. You can name them in any order.':
    'Desloque-se para ver todos os campos. Pode nomeá-los em qualquer ordem.',
  'Drag an audio file or a PDF here': 'Arraste aqui um ficheiro de áudio ou um PDF',
  'MP3, WAV, OGG, PDF or image': 'MP3, WAV, OGG, PDF ou imagem',
  'Pause': 'Pausa',
  'Resume': 'Retomar',
  'Finish recording': 'Terminar a gravação',
  'Your recording': 'A sua gravação',
  'Dino AI is reading your recording…': 'Dino AI está a analisar a sua gravação…',
  'text': 'texto',
