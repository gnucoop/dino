...
export const AR: Translation = {
  ...
  'No': 'لا',
  '{{count}} sections need attention': '{{count}} أقسام تحتاج إلى الانتباه',
  'Cannot save, some sections need attention': 'لا يمكن الحفظ، بعض الأقسام تحتاج إلى الانتباه',
  'Number of {{name}}': 'عدد {{name}}',
  ...
  'Section': 'القسم',
  'Section {{current}} of {{total}}': 'القسم {{current}} من {{total}}',
  'Previous section': 'القسم السابق',
  'Next section': 'القسم التالي',
  '{{percent}}% filled': 'تم ملء {{percent}}%',
  '{{done}} of {{total}} sections complete': '{{done}} من {{total}} أقسام مكتملة',
  'More below': 'المزيد أدناه',
  'Search section': 'ابحث عن قسم',
  'No section matches': 'لا يوجد قسم مطابق',
