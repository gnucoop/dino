...
export const AR: Translation = {
  ...
  'Use': 'استخدم',
  'for dynamic placeholders.': 'للعناصر النائبة الديناميكية.',
  'optional': 'اختيارية',
  'filled': 'مكتملة',
  'Source text': 'النص الأصلي',
  'Translation {{language}}…': 'ترجمة {{language}}…',
  ...
  'keys': 'مفاتيح',
  'complete': 'مكتمل',
  'Search key or text…': 'ابحث عن مفتاح أو نص…',
  'All keys': 'الكل',
  'To translate': 'بحاجة إلى ترجمة',
  'No results': 'لا توجد نتائج',
  'Translation key': 'مفتاح الترجمة',
  'Rename key': 'إعادة تسمية المفتاح',
  'languages translated': 'لغات مترجمة',
  'Saving…': 'جارٍ الحفظ…',
  'Saved': 'تم الحفظ',
  ...
  'Ask a question in natural language about this form data': 'اطرح سؤالاً بلغة طبيعية حول بيانات هذا النموذج',
  'Write a question about the data...': 'اكتب سؤالاً عن البيانات...',
  'New chat': 'محادثة جديدة',
  'Chats': 'المحادثات',
  'Delete chat': 'حذف المحادثة',
  'Today': 'اليوم',
  'Yesterday': 'أمس',
  '{{days}} days ago': 'قبل {{days}} أيام',
  'Last week': 'الأسبوع الماضي',
  'Good response': 'إجابة جيدة',
  'Bad response': 'إجابة سيئة',
  'Suggested questions': 'أسئلة مقترحة',
  'Copy': 'نسخ',
  'Copied': 'تم النسخ',
  'Regenerate answer': 'إعادة توليد الإجابة',
  'Could not download the export file': 'تعذر تنزيل ملف التصدير',
  'The chat session has ended. Please run the query again': 'انتهت جلسة المحادثة. من فضلك أعد طرح السؤال',
  'This download is no longer available. Please run the query again': 'لم يعد هذا التنزيل متاحًا. من فضلك أعد طرح السؤال',
  'Showing the first {{preview}} of {{total}} rows': 'يتم عرض أول {{preview}} صفوف من أصل {{total}}',
  'Not all rows are shown': 'لا يتم عرض جميع الصفوف',
  'Only {{preview}} of {{total}} columns are shown': 'يتم عرض {{preview}} أعمدة فقط من أصل {{total}}',
  'This chart could not be displayed': 'تعذر عرض هذا الرسم البياني',
  'No data to display': 'لا توجد بيانات للعرض',
  'How many records were collected this month?': 'كم عدد السجلات التي تم جمعها هذا الشهر؟',
  'Summarize the collected notes': 'لخّص الملاحظات المجمعة',
  'Compare the activities by organization': 'قارن الأنشطة حسب المنظمة',
  ...
  'DINO Theme': 'سمة DINO',
  'DINO-AI API Key': 'مفتاح API لـ DINO-AI',
  'Download backup': 'تنزيل النسخة الاحتياطية',
  'Export a full copy of the data, or restore a previous backup.': 'صدِّر نسخة كاملة من البيانات، أو استعد نسخة احتياطية سابقة.',
  'Hide': 'إخفاء',
  'Load preset': 'تحميل الإعداد المسبق',
  'No DINO-AI key is associated with this account': 'لا يوجد مفتاح DINO-AI مرتبط بهذا الحساب',
  'Pick a color': 'اختر لوناً',
  'Preset name': 'اسم الإعداد المسبق',
  'Preview': 'معاينة',
  'Primary': 'أساسي',
  'Reset': 'إعادة تعيين',
  'Restoring overwrites the current data': 'الاستعادة تستبدل البيانات الحالية',
  'Save theme': 'حفظ السمة',
  'Take the guided tour of Dino again.': 'أعد الجولة الإرشادية في Dino.',
  ...
  'With active filters': 'مع عوامل التصفية النشطة',
  'Sections': 'الأقسام',
  'All fields': 'كل الحقول',
  'Selected fields': 'الحقول المحددة',
  'Value format': 'تنسيق القيم',
  'Search field...': 'ابحث عن حقل...',
  'Select all': 'تحديد الكل',
  'Deselect': 'إلغاء التحديد',
  'fields selected out of': 'حقول محددة من أصل',
  'Select all Form fields': 'تحديد كل حقول النموذج',
  'Label values': 'قيم التسميات',
  'Data Analysis format': 'تنسيق تحليل البيانات',
  'Separate columns': 'أعمدة منفصلة',
  ...
  'These values decide how the submission is dated and grouped in reports and aggregations. Nothing here is part of the questionnaire itself.':
    'تحدد هذه القيم تاريخ الإدخال وكيفية تجميعه في التقارير والتجميعات. لا شيء هنا جزء من الاستبيان نفسه.',
  'Select…': 'اختر…',
  'Change': 'تغيير',
  'New': 'جديد',
  'Case management': 'إدارة الحالات',
  'Form status associated with the form': 'الحالة المرتبطة بالنموذج',
  'fields': 'حقول',
  'Scroll to see all the fields. You can name them in any order.':
    'مرّر لعرض جميع الحقول. يمكنك ذكرها بأي ترتيب.',
  'Drag an audio file or a PDF here': 'اسحب ملفًا صوتيًا أو PDF إلى هنا',
  'MP3, WAV, OGG, PDF or image': 'MP3 أو WAV أو OGG أو PDF أو صورة',
  'Pause': 'إيقاف مؤقت',
  'Resume': 'استئناف',
  'Finish recording': 'إنهاء التسجيل',
  'Your recording': 'تسجيلك',
  'Dino AI is reading your recording…': 'يقوم Dino AI بتحليل تسجيلك…',
  'text': 'نص',
  'long text': 'نص طويل',
  'number': 'رقم',
  'yes / no': 'نعم / لا',
