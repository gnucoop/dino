...
export const ITA: Translation = {
  ...
  'Define the key and, if you want, translate it right away. You can complete the other languages later.':
    'Definisci la chiave e, se vuoi, traducila subito. Puoi completare le altre lingue in seguito.',
  ...
  'The languages left empty stay marked as missing.':
    'Le lingue lasciate vuote restano segnate come mancanti.',
  'All languages': 'Tutte le lingue',
  'Review, import and export the whole dictionary of a language.':
    'Rivedi, importa ed esporta l’intero dizionario di una lingua.',
  ...
  'Read-only preview. Single translations are edited from the Translations page.':
    'Anteprima in sola lettura. Le singole traduzioni si modificano dalla pagina Traduzioni.',
  ...
  'A {{schema_name}} Form with this exact set of Metrics already exists. Please choose different Metrics':
    'Un Form {{schema_name}} con questo preciso set di Metriche esiste già. Per favore, seleziona Metriche diverse',
  ...
  'Some files were stored locally due to a temporary network problem. Click to sync these files.':
    'Alcuni file sono stati salvati localmente a causa di un problema di rete temporaneo. Clicca per sincronizzarli.',
  'Some files could not be uploaded. Please retry.':
    'Alcuni file non sono stati caricati. Per favore riprova.',
  'Close': 'Chiudi',
  'CLOSE': 'CHIUDI',
  ...
  'Document saved. Some files were stored locally due to a temporary network problem. You can sync these files later by clicking the upload icon.':
    "Documento salvato. Alcuni file sono stati salvati localmente a causa di un problema di rete temporaneo. Puoi sincronizzarli in seguito cliccando sull'icona di caricamento.",
  ...
  'Enter the name of the metric field or attributes to add to the choice, separated by commas. They can be used later in the choice_filter.':
    'Inserisci i nomi dei campi o attributi della metrica da aggiungere alla scelta (separati da virgola). Potranno essere usati nel choice_filter.',
  ...
  'File not imported! Columns must match formschema fields.':
    'File non importato! Le colonne devono corrispondere ai campi di formechema.',
  ...
  'File not imported: no valid metrics to import found in the file.':
    'File non importato: nessuna metrica valida da importare trovata nel file.',
  ...
  'If specified, only forms completed with a creation date within the range will be included in the report.':
    "Se specificato, verranno inclusi nel report solamente i formulari compilati con una data di creazione all'interno dell'intervallo.",
  ...
  'In the latter case, no filter will be applied to the completed forms based on the creation date.':
    "In quest'ultimo caso non verrà applicato nessun filtro ai formulari compilati, sulla base della data di creazione.",
  'Include': 'Includi',
  ...
  'Insert a formula to filter metrics, using metric fields or attributes':
    "Inserisci una formula per filtrare le metriche, usando campi o attributi delle metriche. Usa: attribute = 'val' o attribute != true o attribute = false o date_start >= '2024-04-2'",
  ...
  'Other Forms depend on this Form Schema and some of its fields. Are you sure you want to delete it?':
    'Altri Form dipendono da questo Form Schema e alcuni dei suoi campi. Sicuro di volerlo eliminare?',
  ...
  'Resyncing {{collection}} attempt {{retrySyncAttempts}}':
    'Sincronizzazione di {{collection}} tentativo {{retrySyncAttempts}}',
  ...
  'Selects the metrics to be included as choice options in the form schema. The name of the new choice origin will be $metricName_metric_choice.':
    'Seleziona le metriche da includere come opzioni di scelta nello schema del form. Il nome della nuova choice sarà $metricName_metric_choice. (e.g project_metric_choice o case_metric_choice)',
  'Share Public Url': 'Condividi Link Pubblico',
  'Show Map': 'Mostra mappa',
  'Something went wrong while recording audio':
    "Qualcosa è andato storto durante la registrazione dell'audio",
  'Something went wrong while transcribing audio':
    "Qualcosa è andato storto durante la trascrizione dell'audio",
  "Sorry, you don't have enough Credits!": 'Scusa, non hai abbastanza crediti!',
  'Sources': 'Fonti',
  'Specify a date range to filter the data (optional).':
    'Specificare un intervallo di date per filtrare i dati (opzionale).',
  ...
  'Synchronization complete with errors. Could not synchronize: {{formattedCollectionsWithProblems}}. Please check your notifications.':
    'Sincronizzazione completata con errori. Non è stato possibile sincronizzare: {{formattedCollectionsWithProblems}}. Per favore controlla le tue notifiche.',
  ...
  'The corresponding graphql query condition to filter metrics':
    'La corrispondente condizione per la query graphql per filtrare le metriche',
  ...
  'There are not any Forms currently available. Please add a Form to start collecting data.':
    'Non ci sono form attualmente disponibili. Aggiungere un form per iniziare a raccogliere dati.',
  'There are not any Reports currently available. Please add a Report to start reviewing data.':
    'Non ci sono report attualmente disponibili. Aggiungere un report per iniziare a controllare i dati.',
  ...
  'There is Data associated with this Schema. Please delete all associated Data before deleting this Schema.':
    'Ci sono dati associati a questo Schema. Si prega di eliminare tutti i dati associati prima di eliminare questo Schema.',
  ...
  'Upload an xls or csv file to import metrics:':
    'Carica un file XLS o CSV per importare le metriche:',
  ...
  'Use selected field (only one allowed) as choice option. The name of the new choice origin added to the form schema will be $fieldName_choice.':
    'Usa il campo selezionato (solo uno consentito) come opzione di scelta. Il nome della nuova choice aggiunta allo schema sarà $fieldName_choice.',
  'User': 'Utente',
  ...
  'You can specify only one of the two extremes of the range, or neither.':
    "E' possibile specificare solo uno dei due estremi dell'intervallo, oppure nessuno.",
  'You have unsynced data. Please click the Sync icon.':
    "Hai dati non sincronizzati. Fai clic sull'icona di sincronizzazione.",
