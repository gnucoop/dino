...
export const UKR: Translation = {
  ...
  'Use': 'Використовуйте',
  'for dynamic placeholders.': 'для динамічних заповнювачів.',
  ...
  'keys': 'ключів',
  'complete': 'завершено',
  'Search key or text…': 'Пошук ключа або тексту…',
  'All keys': 'Усі',
  'To translate': 'Потребують перекладу',
  'No results': 'Немає результатів',
  'Translation key': 'Ключ перекладу',
  'Rename key': 'Перейменувати ключ',
  'languages translated': 'мов перекладено',
  'Saving…': 'Збереження…',
  'Saved': 'Збережено',
  'Save failed': 'Помилка збереження',
  'Translated': 'Перекладено',
  'Missing': 'Відсутній',
  'Add translation {{language}}…': 'Додати переклад {{language}}…',
  'Select a translation key': 'Виберіть ключ перекладу',
  'Log out': 'Вийти',
  ...
  'Data': 'Дані',
  'Map': 'Карта',
  'Ask your data': 'Запитайте свої дані',
  'Ask a question in natural language about this form data': 'Поставте запитання природною мовою про дані цієї форми',
  'Write a question about the data...': 'Напишіть запитання про дані...',
  'New chat': 'Новий чат',
  'Chats': 'Чати',
  ...
  'Bad response': 'Погана відповідь',
  'Suggested questions': 'Пропоновані запитання',
  'Copy': 'Копіювати',
  'Copied': 'Скопійовано',
  'Regenerate answer': 'Згенерувати відповідь знову',
  'Could not download the export file': 'Не вдалося завантажити експортований файл',
  'The chat session has ended. Please run the query again': 'Сесію чату завершено. Будь ласка, повторіть запитання',
  'This download is no longer available. Please run the query again': 'Це завантаження більше недоступне. Будь ласка, повторіть запитання',
  'Showing the first {{preview}} of {{total}} rows': 'Показано перші {{preview}} рядків із {{total}}',
  'Not all rows are shown': 'Показано не всі рядки',
  'Only {{preview}} of {{total}} columns are shown': 'Показано лише {{preview}} стовпців із {{total}}',
  'This chart could not be displayed': 'Не вдалося показати цю діаграму',
  'No data to display': 'Немає даних для показу',
  'How many records were collected this month?': 'Скільки даних зібрано цього місяця?',
  'Summarize the collected notes': 'Підсумуйте зібрані нотатки',
  'Compare the activities by organization': 'Порівняйте діяльність за організаціями',
  ...
  'Never synchronized': 'Ніколи не синхронізовано',
  'Offline': 'Офлайн',
  'Notifications': 'Повідомлення',
  'Light mode': 'Світла тема',
  'Dark mode': 'Темна тема',
  'User Area': 'Область користувача',
  'Logout': 'Вийти',
  'AI': 'ШІ',
  'RAG': 'RAG',
  'Help': 'Довідка',
  ...
  'DINO Theme': 'Тема DINO',
  'DINO-AI API Key': 'API-ключ DINO-AI',
  'Download backup': 'Завантажити резервну копію',
  'Export a full copy of the data, or restore a previous backup.': 'Експортуйте повну копію даних або відновіть попередню резервну копію.',
  'Hide': 'Сховати',
  'Load preset': 'Завантажити набір',
  'No DINO-AI key is associated with this account': 'З цим обліковим записом не пов’язано жодного ключа DINO-AI',
  'Pick a color': 'Виберіть колір',
  'Preset name': 'Назва набору',
  'Preview': 'Попередній перегляд',
  'Primary': 'Основний',
  'Reset': 'Скинути',
  'Restoring overwrites the current data': 'Відновлення перезапише поточні дані',
  'Save theme': 'Зберегти тему',
  'Take the guided tour of Dino again.': 'Пройдіть екскурсію Dino ще раз.',
  ...
  'With active filters': 'З активними фільтрами',
  'Sections': 'Розділи',
  'All fields': 'Усі поля',
  'Selected fields': 'Вибрані поля',
  'Value format': 'Формат значень',
  'Search field...': 'Пошук поля...',
  'Select all': 'Вибрати все',
  'Deselect': 'Зняти вибір',
  'fields selected out of': 'полів вибрано з',
  'Select all Form fields': 'Вибрати всі поля форми',
  'Label values': 'Значення міток',
  'Data Analysis format': 'Формат Data Analysis',
  'Separate columns': 'Окремі стовпці',
  'Step 1 of 2': 'Крок 1 з 2',
  'Form metrics': 'Метрики форми',
  'Report metrics': 'Метрики звіту',
  'These values decide how the submission is dated and grouped in reports and aggregations. Nothing here is part of the questionnaire itself.':
    'Ці значення визначають дату запису та його групування у звітах і агрегаціях. Нічого з цього не є частиною самої анкети.',
  'Select…': 'Вибрати…',
  'Change': 'Змінити',
  'New': 'Новий',
  'Case management': 'Управління випадками',
  'Form status associated with the form': 'Статус, пов’язаний із формою',
  'fields': 'полів',
  'Scroll to see all the fields. You can name them in any order.':
    'Прокрутіть, щоб побачити всі поля. Їх можна називати в будь-якому порядку.',
  'Drag an audio file or a PDF here': 'Перетягніть сюди аудіофайл або PDF',
  'MP3, WAV, OGG, PDF or image': 'MP3, WAV, OGG, PDF або зображення',
  'Pause': 'Пауза',
  'Resume': 'Продовжити',
  'Finish recording': 'Завершити запис',
  'Your recording': 'Ваш запис',
  'Dino AI is reading your recording…': 'Dino AI аналізує ваш запис…',
  'text': 'текст',
