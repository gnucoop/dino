...
export const ESP: Translation = {
  ...
  'Use': 'Usa',
  'for dynamic placeholders.': 'para los marcadores dinámicos.',
  'optional': 'opcionales',
  'filled': 'completadas',
  ...
  'All keys': 'Todas',
  'To translate': 'Por traducir',
  'No results': 'Sin resultados',
  'Translation key': 'Clave de traducción',
  'Rename key': 'Renombrar clave',
  'languages translated': 'idiomas traducidos',
  'Saving…': 'Guardando…',
  'Saved': 'Guardado',
  ...
  'The sync is stopped: your session has expired. Tap here to log in again with this account and synchronise the data on this device.':
    'La sincronización está detenida: tu sesión ha caducado. Toca aquí para iniciar sesión de nuevo con esta cuenta y sincronizar los datos de este dispositivo.',
  'Data collected with the account {{account}} is still on this device. Log in with that account to synchronise it: logging in with a different one deletes it.':
    'Los datos recogidos con la cuenta {{account}} siguen en este dispositivo. Inicia sesión con esa cuenta para sincronizarlos: si inicias sesión con otra, se borran.',
  'Data collected on this device has not been synchronised yet. Log in with the account that collected it: logging in with a different one deletes it.':
    'Los datos recogidos en este dispositivo aún no se han sincronizado. Inicia sesión con la cuenta que los recogió: si inicias sesión con otra, se borran.',
  ...
  'Rows rejected': 'Filas rechazadas',
  'Rows in file': 'Filas del archivo',
  'Metrics created': 'Métricas creadas',
  'Search by row or error': 'Buscar por fila o error',
  'File row': 'Fila del archivo',
  'Error': 'Error',
  'and other {{n}}': 'y otras {{n}}',
  'All the rows of the file have been saved.': 'Todas las filas del archivo se han guardado.',
  '{{n}} rows not imported: refused on save': '{{n}} filas no importadas: rechazadas al guardar',
  'Choose the file with the data to be imported.':
    'Elige el archivo con los datos que quieres importar.',
  'Invalid user ids': 'Id de usuario no válidos',
  'Invalid metric ids': 'Id de métrica no válidos',
  'Invalid form status': 'Estados no válidos',
  'Rows not imported': 'Filas no importadas',
  'metric with invalid parent': 'métrica con padre no válido',
  'metric not created': 'métrica no creada',
  'Field mapped to more than one column': 'Campo asociado a más de una columna',
  ...
  'Add': 'Añadir',
  'Add all shown': 'Añadir todos los mostrados',
  'Added': 'Añadido',
  'Clear': 'Vaciar',
  'In group': 'En el grupo',
  'results': 'resultados',
  'Filter assigned…': 'Filtrar asignados…',
  'Nothing added for this category yet.': 'Aún no se ha añadido nada a esta categoría.',
  'Create group': 'Crear grupo',
  'Edit group': 'Editar grupo',
  'View group': 'Ver grupo',
  'saved': 'guardado',
  'Oops! Something went wrong while performing the requested action.':
    '¡Vaya! Algo salió mal al realizar la acción solicitada.',
  ...
  'Could not download the export file': 'No se ha podido descargar el archivo exportado',
  'The chat session has ended. Please run the query again': 'La sesión de chat ha terminado. Por favor, repite la pregunta',
  'This download is no longer available. Please run the query again': 'Esta descarga ya no está disponible. Por favor, repite la pregunta',
  'Showing the first {{preview}} of {{total}} rows': 'Se muestran las primeras {{preview}} filas de {{total}}',
  'Not all rows are shown': 'No se muestran todas las filas',
  'Only {{preview}} of {{total}} columns are shown': 'Solo se muestran {{preview}} columnas de {{total}}',
  'This chart could not be displayed': 'No se ha podido mostrar este gráfico',
  ...
  'DINO Theme': 'Tema DINO',
  'DINO-AI API Key': 'Clave API de DINO-AI',
  'Download backup': 'Descargar copia de seguridad',
  'Export a full copy of the data, or restore a previous backup.': 'Exporta una copia completa de los datos o restaura una copia de seguridad anterior.',
  'Hide': 'Ocultar',
  'Load preset': 'Cargar preajuste',
  'No DINO-AI key is associated with this account': 'No hay ninguna clave DINO-AI asociada a esta cuenta',
  'Pick a color': 'Elegir un color',
  'Preset name': 'Nombre del preajuste',
  'Preview': 'Vista previa',
  'Primary': 'Primario',
  'Reset': 'Restablecer',
  'Restoring overwrites the current data': 'La restauración sobrescribe los datos actuales',
  'Save theme': 'Guardar tema',
  'Show': 'Mostrar',
  'Take the guided tour of Dino again.': 'Vuelve a hacer el recorrido guiado de Dino.',
  'Update password': 'Actualizar contraseña',
  'Warning': 'Advertencia',
  'Your DINO-AI access key and the credits available to you.': 'Tu clave de acceso a DINO-AI y los créditos disponibles.',
  'Earlier': 'Antes',
  ...
  'With active filters': 'Con filtros activos',
  'Sections': 'Secciones',
  ...
  'fields selected out of': 'campos seleccionados de',
  'Select all Form fields': 'Seleccionar todos los campos del formulario',
  'Label values': 'Valores de etiqueta',
  'Data Analysis format': 'Formato Data Analysis',
  'Separate columns': 'Columnas separadas',
  'Step 1 of 2': 'Paso 1 de 2',
  'Form metrics': 'Métricas del formulario',
  'Report metrics': 'Métricas del informe',
  'These values decide how the submission is dated and grouped in reports and aggregations. Nothing here is part of the questionnaire itself.':
    'Estos valores determinan la fecha del registro y cómo se agrupa en informes y agregaciones. Nada de esto forma parte del cuestionario en sí.',
  'Select…': 'Seleccionar…',
  'Change': 'Cambiar',
  'New': 'Nuevo',
  'Case management': 'Gestión de casos',
  'Form status associated with the form': 'Estado asociado al formulario',
  'fields': 'campos',
  'Scroll to see all the fields. You can name them in any order.':
    'Desplázate para ver todos los campos. Puedes nombrarlos en cualquier orden.',
  'Drag an audio file or a PDF here': 'Arrastra aquí un archivo de audio o un PDF',
  'MP3, WAV, OGG, PDF or image': 'MP3, WAV, OGG, PDF o imagen',
  'Pause': 'Pausa',
  'Resume': 'Reanudar',
  'Finish recording': 'Finalizar la grabación',
  'Your recording': 'Tu grabación',
  'Dino AI is reading your recording…': 'Dino AI está analizando tu grabación…',
  'text': 'texto',
