...
export const ESP: Translation = {
  ...
  'Section': 'Sección',
  'Section {{current}} of {{total}}': 'Sección {{current}} de {{total}}',
  'Previous section': 'Sección anterior',
  'Next section': 'Sección siguiente',
  '{{percent}}% filled': '{{percent}}% completado',
  '{{done}} of {{total}} sections complete': '{{done}} de {{total}} secciones completas',
  'More below': 'Más abajo',
  'Search section': 'Buscar sección',
  'No section matches': 'Ninguna sección coincide',
