 ...
 *
 * The field is always visible and editable: which filters exist at all is decided
 * upstream by the list, that evaluates the form schema visibility conditions with
