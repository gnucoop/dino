---
name: repomix-reference-scripts
description: Reference codebase for Scripts. Use this skill when you need to understand the structure, implementation patterns, or code details of the Scripts project.
---

# Scripts Codebase Reference

38 files | 372 lines | 3552 tokens
