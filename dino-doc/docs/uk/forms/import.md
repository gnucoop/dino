...
!!! tip "Прості формати файлів"
    Dino приймає той самий файл, отриманий під час [експорту](index.md#експорт). Отже, найпростіший спосіб отримати файл, належним чином відформатований для імпорту, — спочатку експортувати деякі дані form з тієї ж схеми, а потім видалити рядки з експортованими даними, залишивши лише заголовки стовпців. У будь-якому разі переконайтеся, що заголовки стовпців зрозумілі — вони використовуватимуться як підказки під час зіставлення.
...
5. Поля дати потрібно форматувати як YYYY-MM-DD у вигляді тексту (будьте уважні).   
