...
*   From the main [Reports](index.md) list, click on a report's title or an edit action.
*   From within a report's detailed view, look for an **Edit** button or link.

## Editing Report Information

Once on the Edit Report page, you will see a form similar to the one used for creating a report. The form will be pre-filled with the report's current data.

### Steps to Edit a Report

1.  **Review the pre-filled data** in the form fields.
2.  **Make your changes** to any of the available fields, such as:
    *   **Primary Metrics:** Update the main numerical values for the report.
    *   **Secondary Metrics:** Edit additional data points if they are configured for your form schema.
...
!!! tip "Optional Fields"
    Depending on your organization's configuration, some metric fields may be optional. These are often marked as such. You can leave optional fields blank if no data is available.
...
If you need to edit information that does not appear as a field, contact your administrator, as the form schema may need to be updated. You can learn more about the underlying structure in the [Edit Report Schema](edit-report-schema.md) documentation.
