...
The Reset Password page lets you choose a new password after requesting a reset link. You arrive here by clicking the link sent to your email address — the same link you requested from the **"Forgot your password?"** option on the [Login page](login.md).
