...
4.  Click the arrow button to save.

An error message will appear if the current password is incorrect or if the new passwords do not match.
...
!!! warning "Restore Caution"
    Restoring data will replace the current database. This action cannot be undone.