---
title: Benvenuto in Dino
description: Un'introduzione a Dino — cos'è, a chi è rivolto e come orientarsi in questa documentazione.
---

# Benvenuto in Dino

Dino è una piattaforma web per la raccolta strutturata di dati, il monitoraggio e l'analisi. Offre ai team un unico posto per progettare moduli, raccogliere informazioni sul campo, monitorare i progressi ed esplorare i risultati, sia online che in ambienti a bassa connettività.
...
*   [Aggregare i dati](aggregation/index.md)
...
*   [Visualizzare l'elenco gruppi](administration/groups-list.md)
...
1.  [Effettuare il login](getting-started/login.md) — accedi al tuo account.
2.  [Resettare la password](getting-started/reset-password.md) — imposta una nuova password se necessario.

---

## Accesso e permessi

Ciò che puoi vedere e fare in Dino dipende dai gruppi di permessi assegnati al tuo account. Alcune aree, come l'amministrazione e la gestione degli schemi dei moduli, sono visibili solo agli utenti con il ruolo appropriato. Se non trovi una funzionalità descritta in questa documentazione, contatta il tuo amministratore di sistema.