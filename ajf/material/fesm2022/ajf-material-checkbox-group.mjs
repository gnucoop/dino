...
class CheckboxGroupItem extends AjfCheckboxGroupItem {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CheckboxGroupItem, selectors: [["ajf-checkbox-group-item"]], hostVars: 5, hostBindings: function CheckboxGroupItem_HostBindings(rf, ctx) { if (rf & 2) {
        ...
        } }, dependencies: [i2.MatButton, i3.MatIcon, i4.AsyncPipe], styles: ["ajf-checkbox-group-item{display:inline-flex;min-width:0}ajf-checkbox-group-item .mat-mdc-button{--mdc-text-button-label-text-weight: 400;--mat-text-button-horizontal-padding: 14px;--mat-text-button-with-icon-horizontal-padding: 14px;font-weight:400;height:auto;display:inline-flex;align-items:center;justify-content:flex-start;gap:8px;box-sizing:border-box;min-width:0;min-height:var(--ajf-control-h, 44px);border:1px solid var(--ajf-border-strong, #d5cfc6);border-radius:var(--ajf-radius, 4px);background:var(--ajf-surface, #fff);color:var(--ajf-text, #1c1a17);font-size:14px;letter-spacing:normal}ajf-checkbox-group-item .mat-mdc-button:hover{border-color:var(--ajf-accent, #0f4c5c)}ajf-checkbox-group-item .mat-mdc-button .mat-icon{flex:0 0 auto;width:18px;height:18px;margin:0;color:var(--ajf-text-faint, #a49c92);font-size:18px}ajf-checkbox-group-item .mat-mdc-button .mdc-button__label{min-width:0;overflow-wrap:anywhere;text-align:left}ajf-checkbox-group-item .mat-mdc-button.ajf-checked{border-color:var(--ajf-accent, #0f4c5c);background:var(--ajf-accent-soft, #e8f1f5);color:var(--ajf-accent, #0f4c5c)}ajf-checkbox-group-item .mat-mdc-button.ajf-checked .mat-icon{color:var(--ajf-accent, #0f4c5c)}\n"], encapsulation: 2, changeDetection: 0 }); }
}
