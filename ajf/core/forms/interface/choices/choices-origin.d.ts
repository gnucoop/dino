...
export type AjfChoicesOrigin<T> = AjfChoicesFixedOrigin<T> | AjfChoicesFunctionOrigin<T> | AjfChoicesObservableArrayOrigin<T> | AjfChoicesObservableOrigin<T> | AjfChoicesPromiseOrigin<T>;
//# sourceMappingURL=choices-origin.d.ts.map