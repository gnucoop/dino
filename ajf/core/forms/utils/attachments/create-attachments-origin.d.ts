...
export type AjfAttachmentsOriginCreate<T> = Pick<AjfAttachmentsOrigin<T>, 'name'> & Partial<AjfAttachmentsOrigin<T>>;
/**
...
//# sourceMappingURL=create-attachments-origin.d.ts.map