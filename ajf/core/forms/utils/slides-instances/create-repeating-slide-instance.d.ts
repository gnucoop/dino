...
export type AjfRepeatingSlideInstanceCreate = Omit<AjfSlideInstanceCreate, 'node'> & Pick<AjfRepeatingSlideInstance, 'node'> & Partial<AjfRepeatingSlideInstance>;
/**
...
//# sourceMappingURL=create-repeating-slide-instance.d.ts.map