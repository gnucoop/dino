...
export declare const isWidgetWithContentInstance: (instance: AjfWidgetInstance) => instance is AjfColumnWidgetInstance | AjfLayoutWidgetInstance | AjfDialogWidgetInstance;
//# sourceMappingURL=is-widget-with-content-instance.d.ts.map