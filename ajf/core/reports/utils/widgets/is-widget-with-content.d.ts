...
export declare const isWidgetWithContent: (widget: AjfWidget) => widget is AjfColumnWidget | AjfLayoutWidget | AjfDialogWidget;
//# sourceMappingURL=is-widget-with-content.d.ts.map