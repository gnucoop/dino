 ...
 *
 *   node ./scripts/run-component-tests reports           | Runs Material reports tests
 *   node ./scripts/run-component-tests data              | Runs Core data chart
 *   node ./scripts/run-component-tests src/core/reports  | Runs Core reports tests
 *   node ./scripts/run-component-tests data auth         | Runs Core data and auth tests
 *
