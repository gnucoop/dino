module.exports = () => {
  ...
  return {
    projectRoot: __dirname, repository: {
      user: 'gnucoop',
      name: 'dewco',
    },
        ...
        githubApiMerge:
            {default: 'squash', labels: [{pattern: 'preserve commits', method: 'rebase'}]},
        claSignedLabel: 'cla: yes', mergeReadyLabel: 'merge ready',
        commitMessageFixupLabel: 'commit message fixup', labels: [
          {
